...
slackInteractions.action({ type: "button" }, (payload) => {
  ...
  const feedback_dialog = {
    ...
    dialog: JSON.stringify({
      ...
      elements: [
        {
          label: "How's your presentation prep going?",
          type: "select",
          name: "tester",
          ...
          options: [
            ...
            { label: "OK", value: "ok" },
            { label: "Bad", value: "bad" },
            { label: "Horribly", value: "horribly" },
          ],
        },
        // {
        //   label: "The pace of the material has been...",
        //   type: "select",
        //   name: "pace",
        ...
        // },
        // {
        //   label: "Combo of lecture & reading material has been...",
        //   type: "select",
        //   name: "combo",
        ...
        [
          {
            fields: {
              ...
              "Test Run with SWE": payload.submission.tester,
